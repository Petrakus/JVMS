...
public class JVMS {
    ...
    /**
     * Note: Only valid for string properties
     * Valid for visa, mastercard, discover, american express, diners, jcb
     */
    public static Validation<Object> isCreditCardNumber() {
        ...
        Pattern pattern = Pattern.compile(regex);
        return GenericValidation.from(s -> pattern.matcher((String)s).matches(), "is not a valid credit card number.");
    }
}
